...
| Jornada parcial y extraordinaria       | El perfil distingue tiempo completo/parcial, minutos semanales contratados y existencia de pacto de horas complementarias. Cuando la distribución varía, la empresa registra previamente cada planificación semanal con su vigencia; archivar su ficha no elimina su efecto histórico. El cierre mensual bloquea contratos sin clasificar, secuencias anómalas, solicitudes pendientes y excesos parciales sin pacto, y separa minutos planificados, ordinarios, complementarios y extraordinarios. El CSV del cierre conserva esos totales, la huella y el desglose diario. |
