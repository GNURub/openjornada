...
15. Inventariar los terminales RFID, limitar el acceso físico, rotar o revocar
    ...
    no debe presentarse como autenticación fuerte. Mantener
    `PB_TERMINAL_DEV_INSECURE_HTTP=false` en producción y comprobar que los
    terminales usan HTTPS.
